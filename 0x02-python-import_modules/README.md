...
```sh
steve@ubuntu:~/0x02$ cat add_0.py
#!/usr/bin/python3
def add(a, b):
...
steve@ubuntu:~/0x02$ ./0-add.py
1 + 2 = 3
steve@ubuntu:~/0x02$ cat 0-import_add.py
__import__("0-add")
steve@ubuntu:~/0x02$ python3 0-import_add.py 
```
File: `0-add.py`
...
steve@ubuntu:~/0x02$ cat calculator_1.py
#!/usr/bin/python3
def add(a, b):
    """My addition function
...
steve@ubuntu:~/0x02$ ./1-calculation.py
10 + 5 = 15
10 - 5 = 5
10 * 5 = 50
10 / 5 = 2
...
steve@ubuntu:~/0x02$ ./2-args.py 
0 arguments.
steve@ubuntu:~/0x02$ ./2-args.py Hello
1 argument:
1: Hello
steve@ubuntu:~/0x02$ ./2-args.py Hello Welcome To The Best School
6 arguments:
1: Hello
2: Welcome
3: To
...
steve@ubuntu:~/0x02$ ./3-infinite_add.py
0
steve@ubuntu:~/0x02$ ./3-infinite_add.py 79 10
89
steve@ubuntu:~/0x02$ ./3-infinite_add.py 79 10 -40 -300 89 
-162
...
steve@ubuntu:~/0x02$ curl -Lso "hidden_4.pyc" "https://github.com/alx-tools/0x02.py/raw/master/hidden_4.pyc"
steve@ubuntu:~/0x02$ ./4-hidden_discovery.py | sort
my_secret_santa
print_hidden
print_school
...
steve@ubuntu:~/0x02$ cat variable_load_5.py
#!/usr/bin/python3
a = 98
"""Simple variable
"""

steve@ubuntu:~/0x02$ ./5-variable_load.py
98
...
stevecmd@DESKTOP-UTB295U:~/alx-higher_level_programming/0x02-python-import_modules$ cat calculator_1.py
#!/usr/bin/python3
def add(a, b):
    """My addition function
...
stevecmd@DESKTOP-UTB295U:~/alx-higher_level_programming/0x02-python-import_modules$ chmod u+x 101-easy_print.py 
stevecmd@DESKTOP-UTB295U:~/alx-higher_level_programming/0x02-python-import_modules$ ./101-easy_print.py
#pythoniscool
...
stevecmd@DESKTOP-UTB295U:~/alx-higher_level_programming/0x02-python-import_modules$ chmod u+x 103-fast_alphabet.py 
stevecmd@DESKTOP-UTB295U:~/alx-higher_level_programming/0x02-python-import_modules$ ./103-fast_alphabet.py 
